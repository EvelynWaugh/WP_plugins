...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ChatboxContainer; });
...
var Chatbox = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div(_templateObject());
function ChatboxContainer(_ref) {
  var children = _ref.children,
      restProps = _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_0___default()(_ref, ["children"]);

  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(Chatbox, restProps, children);
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ConversationsContainer; });
/* harmony import */ var _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/objectWithoutProperties */ "./node_modules/@babel/runtime/helpers/objectWithoutProperties.js");
/* harmony import */ var _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _babel_runtime_helpers_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/taggedTemplateLiteral */ "./node_modules/@babel/runtime/helpers/taggedTemplateLiteral.js");
/* harmony import */ var _babel_runtime_helpers_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_taggedTemplateLiteral__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _SingleConversation__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./SingleConversation */ "./src/components/SingleConversation.js");
...
var Conversations = styled_components__WEBPACK_IMPORTED_MODULE_4__["default"].div(_templateObject());
function ConversationsContainer(_ref) {
  var children = _ref.children,
      restProps = _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_0___default()(_ref, ["children"]);

  var _useContext = Object(react__WEBPACK_IMPORTED_MODULE_3__["useContext"])(_context_Context__WEBPACK_IMPORTED_MODULE_5__["MessageContext"]),
      conversation = _useContext.conversation;

  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(Conversations, restProps, conversation === null || conversation === void 0 ? void 0 : conversation.conversations.map(function (conv) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(_SingleConversation__WEBPACK_IMPORTED_MODULE_6__["default"], {
      name: conv.name,
      id: conv.id,
      key: conv.id,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MessageContainer; });
...
/* harmony import */ var _hooks_inputHook__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../hooks/inputHook */ "./src/hooks/inputHook.js");
...
var MessageBox = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div(_templateObject(), function (props) {
  return props.owner === "true" ? "flex-start" : "flex-end";
}, function (props) {
  return props.owner === "true" ? "left" : "right";
});
var MessageHeader = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div(_templateObject2(), function (props) {
  return props.owner === "true" ? "" : "auto";
});
var MessageBody = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div(_templateObject3());
var MessageBottom = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div(_templateObject4());
var MessageInput = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].input(_templateObject5());
function MessageContainer(props) {
  var _messages$messages;

  var _setInput = Object(_hooks_inputHook__WEBPACK_IMPORTED_MODULE_9__["setInput"])({
    message: ""
  }),
      _setInput2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2___default()(_setInput, 3),
      input = _setInput2[0],
      reset = _setInput2[1],
      saveInputValue = _setInput2[2];

  var _useContext = Object(react__WEBPACK_IMPORTED_MODULE_5__["useContext"])(_context_Context__WEBPACK_IMPORTED_MODULE_8__["MessageContext"]),
      messages = _useContext.messages,
      setMessages = _useContext.setMessages,
      currUser = _useContext.currUser,
      conversation = _useContext.conversation;

  var location = Object(react_router_dom__WEBPACK_IMPORTED_MODULE_7__["useLocation"])();
  console.log(location.search);
  var convid = new URLSearchParams(location.search).get("conversation");
  Object(react__WEBPACK_IMPORTED_MODULE_5__["useEffect"])(function () {
    var url = API_EV.ajaxUrl;
    var params = new URLSearchParams({
      action: "grab_conv_message",
      convId: convid
    });
    axios__WEBPACK_IMPORTED_MODULE_10___default.a.post(url, params, {
      headers: {
        "Content-Type": "application/x-www-form-urlencoded" // "X-WP-Nonce": api.nonce,
  ...
  }, [convid]); // const getCurrConv = conversation?.conversations.filter(
  ...
  function postPrMessage(e) {
    e.preventDefault();
    var url = API_EV.ajaxUrl;
    var current_user = currUser.user.id;
    var getCurrConv = conversation === null || conversation === void 0 ? void 0 : conversation.conversations.filter(function (conv) {
      return conv.id === convid;
    });
    var reciever_user = current_user == getCurrConv[0].sender ? getCurrConv[0].reciever : getCurrConv[0].sender;
    var params = new URLSearchParams({
    ...
    axios__WEBPACK_IMPORTED_MODULE_10___default.a.post(url, params, {
      ...
      setMessages(_objectSpread(_objectSpread({}, messages), {}, {
        messages: [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(messages.messages), [res.data.message])
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__["createElement"])("div", null, messages === null || messages === void 0 ? void 0 : (_messages$messages = messages.messages) === null || _messages$messages === void 0 ? void 0 : _messages$messages.map(function (message) {
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__["createElement"])(MessageBox, {
      owner: message.owner
    }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__["createElement"])(MessageHeader, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__["createElement"])("img", {
      src: message.pic
    }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__["createElement"])("div", null, message.sender_name)), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__["createElement"])(MessageBody, null, message.message));
  }), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__["createElement"])(MessageBottom, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__["createElement"])("form", {
    onSubmit: postPrMessage
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__["createElement"])(MessageInput, {
    type: "text",
    name: "message",
    value: input.message,
...
/***/ "./src/components/SingleConversation.js":
/*!**********************************************!*\
  !*** ./src/components/SingleConversation.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SingleConversation; });
...
var ConvBox = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div(_templateObject());
var HeaderConv = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div(_templateObject2());
var BodyConv = styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].div(_templateObject3());
function SingleConversation(_ref) {
  var children = _ref.children,
      restProps = _babel_runtime_helpers_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_2___default()(_ref, ["children"]);
  ...
  var url = API_EV.ajaxUrl; //   useEffect(() => {
  //     console.log("render");
  ...
  var pushToConversation = Object(react__WEBPACK_IMPORTED_MODULE_5__["useCallback"])( /*#__PURE__*/_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    var params;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            params.append("action", "grab_conv_message");
            params.append("convId", restProps.id);
            history.push("?conversation=".concat(restProps.id));
            console.log(history); // await axios
            //   .post(url, params, {
            //     headers: {
            //       "Content-Type": "application/x-www-form-urlencoded",
            //       // "X-WP-Nonce": api.nonce,
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__["createElement"])(ConvBox, {
    onClick: pushToConversation
  }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__["createElement"])(HeaderConv, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__["createElement"])("div", null, restProps.name), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__["createElement"])("div", null, restProps.time)), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__["createElement"])(BodyConv, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__["createElement"])("div", null, restProps.message)));
}
...
/*!********************************!*\
  !*** ./src/context/Context.js ***!
  \********************************/
/*! exports provided: MessageContext, MessageProvider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MessageContext", function() { return MessageContext; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MessageProvider", function() { return MessageProvider; });
...
var MessageContext = Object(react__WEBPACK_IMPORTED_MODULE_2__["createContext"])();

function MessageProvider(_ref) {
  var children = _ref.children;

  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(INBOX_EV),
      _useState2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_useState, 2),
      conversation = _useState2[0],
      setConversation = _useState2[1];

  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(USER),
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(MessageContext.Provider, {
    value: {
...
/***/ "./src/hooks/inputHook.js":
/*!********************************!*\
  !*** ./src/hooks/inputHook.js ***!
  \********************************/
/*! exports provided: setInput */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function setInput(value) {
  ...
  function saveInputValue(e) {
    setInput(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, e.target.name, e.target.value));
  }

  function reset(name) {
    setInput(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, name, ""));
  }
...
/* harmony import */ var _components_Chatbox__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/Chatbox */ "./src/components/Chatbox.js");
/* harmony import */ var _components_Conversations__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/Conversations */ "./src/components/Conversations.js");
/* harmony import */ var _components_Messages__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/Messages */ "./src/components/Messages.js");
...
function App() {
  var _useState = useState(USERS_EV.users),
      _useState2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_useState, 2),
      users = _useState2[0],
      setUsers = _useState2[1];

  var _useState3 = useState(API_EV),
      _useState4 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_useState3, 2),
      api = _useState4[0],
      setApi = _useState4[1];
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(react_router_dom__WEBPACK_IMPORTED_MODULE_2__["BrowserRouter"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_context_Context__WEBPACK_IMPORTED_MODULE_3__["MessageProvider"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_components_Chatbox__WEBPACK_IMPORTED_MODULE_4__["default"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_components_Conversations__WEBPACK_IMPORTED_MODULE_5__["default"], null), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_components_Messages__WEBPACK_IMPORTED_MODULE_6__["default"], null))));
}

render(Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(App, null), document.getElementById("ev_chatbox"));
